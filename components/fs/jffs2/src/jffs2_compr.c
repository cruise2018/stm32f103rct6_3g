                        ...
                        uint32_t *datalen, uint32_t *cdatalen)
{
    ...
    case JFFS2_COMPR_MODE_PRIORITY:
        ...
        list_for_each_entry(this, &jffs2_compressor_list, struct jffs2_compressor, list)
        {
...
out:
    D2(list_for_each_entry(this, &jffs2_compressor_list, struct jffs2_compressor, list)
    {
