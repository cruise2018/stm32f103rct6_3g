...
struct inode *jffs2_lookup(struct inode *dir_i, const unsigned char *d_name, int namelen)
{
...
int jffs2_create(struct inode *dir_i, const unsigned char *d_name, int mode,
                 struct inode **new_i)
{
